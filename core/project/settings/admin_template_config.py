...
JAZZMIN_SETTINGS: dict[str, Any] = {
    ...
    'site_title': 'Message Sender Admin',
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    'site_header': 'Message Sender',
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    'site_brand': 'Message Sender',
    ...
    'welcome_sign': 'Welcome to Message Sender',
    # Copyright on the footer
    'copyright': 'Message Sender',
    ...
    'icons': {
        ...
        'contacts.contact': 'fas fa-paper-plane',
        'contract.contract': 'fas fa-sliders-h',
    },
